...
<header>
        <form action="buscador.php"  method="POST">
            <div class="header">
                <input class="buscador" type="search" name="buscador" id="search-box" placeholder="Buscar verdura...">
...
<?php
         ...
         //Realizar consulta
                $sql = "SELECT id_producto, nombre_producto, precio FROM producto WHERE id_categoria = 2";
